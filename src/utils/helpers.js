...
export const listNft = async (
  ...
  const txObj = {
    ...
    args: [
      uri,
      etherValue,
      { royaltyWallet: userAddress, royaltyPercentage: royalty },
      splitPayment,
    ],
  };
  try {
...
export const setFeesToBlockchain = async (fee, userAddress) => {
  const txObj = {
    address: address,
    abi: abi,
    functionName: "setFee",
...
export const getFeesFromBlockchain = async (tokenId) => {
  const obj = {
    address: address,
    abi: abi,
    functionName: "fee",
...
export const releaseEscrowAdmin = async (
  ...
  console.log(tokenId, resolve, description, userAddress);
  const txObj = {
    address: address,
    abi: abi,
    functionName: "resolveDispute",
    args: [tokenId, resolve, description],
  };
  try {
    return await executeWriteFunction(txObj, userAddress);
  } catch (error) {
...
export const handleCurator = async (curator, isCurator, userAddress) => {
  const txObj = {
    address: address,
    abi: abi,
    functionName: "setCurators",
    args: [[curator], isCurator],
  };
  try {
    return await executeWriteFunction(txObj, userAddress);
  } catch (error) {
